      repeat
        ...
        local AegiansLoader = Instance.new("ScreenGui")
        ...
        AegiansLoader.Name = "AegiansLoader"
        AegiansLoader.Parent = game.CoreGui
        AegiansLoader.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
        
        BackFrame.Name = "BackFrame"
        BackFrame.Parent = AegiansLoader
        ...
        sound:Play()
            ...
            wait(1)
            script.Parent.Parent.Parent.Parent.Parent.AegiansLoader:Destroy()
        end
        ...
        local title_string = "Aegians | User Status : "..CheckStatus(game.Players.LocalPlayer.Name).." | %A, %B"
        ...
        Toggles.AimbotEnabledTggle:OnChanged(function()
            Aegians.Aiming.Aimbot.Enabled = Toggles.AimbotEnabledTggle.Value
        end)
        ...
        Options.AimbotPredictionTextbox:OnChanged(function()
            Aegians.Aiming.Aimbot.Prediction = Options.AimbotPredictionTextbox.Value
        end)
        ...
        Options.AimbotHitboxDropdownn:OnChanged(function()
            Aegians.Aiming.Aimbot.Hitbox = Options.AimbotHitboxDropdownn.Value
        end)
        ...
        Toggles.AimbotAlertsTggl:OnChanged(function()
            Aegians.Aiming.Aimbot.Alerts = Toggles.AimbotAlertsTggl.Value
        end)
        ...
        Toggles.AimbotVelocityResolverToggle:OnChanged(function()
            Aegians.Aiming.Aimbot.VelocityResolver = Toggles.AimbotVelocityResolverToggle.Value
        end)
        ...
        Toggles.ReverseResolverAimbotTggle:OnChanged(function()
            Aegians.Aiming.Aimbot.ReverseResolver = Toggles.ReverseResolverAimbotTggle.Value
        end)
        ...
        Toggles.AimbotSmoothingTggle:OnChanged(function()
            Aegians.Aiming.Aimbot.Smoothing.Enabled = Toggles.AimbotSmoothingTggle.Value
        end)
        ...
        Options.AimbotSmoothingTextBox:OnChanged(function()
            Aegians.Aiming.Aimbot.Smoothing.Value = Options.AimbotSmoothingTextBox.Value
        end)
        ...
        Toggles.TargetEnabledToggle:OnChanged(function()
            Aegians.Aiming.Target.Enabled = Toggles.TargetEnabledToggle.Value
        end)
        ...
        Options.TargetPredictionTextbox:OnChanged(function()
            Aegians.Aiming.Target.Prediction = Options.TargetPredictionTextbox.Value
        end)
        ...
        Options.TargetHitboxDropdown:OnChanged(function()
            Aegians.Aiming.Target.Hitbox = Options.TargetHitboxDropdown.Value
        end)
        ...
        Toggles.TargetAlertsTggl:OnChanged(function()
            Aegians.Aiming.Target.Alerts = Toggles.TargetAlertsTggl.Value
        end)
        ...
        Toggles.TargetLookAtTggle:OnChanged(function()
            Aegians.Aiming.Target.LookAt = Toggles.TargetLookAtTggle.Value
        end)
        ...
        Toggles.TargetViewAtTggle:OnChanged(function()
            Aegians.Aiming.Target.ViewAt = Toggles.TargetViewAtTggle.Value
        end)
        ...
        Toggles.PingbasedTggle:OnChanged(function()
            Aegians.Aiming.Target.PingBased = Toggles.PingbasedTggle.Value
        end)
        ...
        Toggles.TracerEnabledTracerTarget:OnChanged(function()
            Aegians.Aiming.Target.Tracer.Enabled = Toggles.TracerEnabledTracerTarget.Value
        end)
        ...
        Options.AddColorPickerForTracerTargetThingy:OnChanged(function()
            Aegians.Aiming.Target.Tracer.Color = Options.AddColorPickerForTracerTargetThingy.Value
        end)
        ...
        Options.TargetTracerFrom:OnChanged(function()
            Aegians.Aiming.Target.Tracer.From = Options.TargetTracerFrom.Value
        end)
        ...
        Toggles.HighlightEnabledTggle:OnChanged(function()
            Aegians.Aiming.Target.Highlight.Enabled = Toggles.HighlightEnabledTggle.Value
        end)
        ...
        Options.HighlightFillColorColorPicker:OnChanged(function()
            Aegians.Aiming.Target.Highlight.FillColor = Options.HighlightFillColorColorPicker.Value
        end)
        ...
        Options.HighlightOutLineColor:OnChanged(function()
            Aegians.Aiming.Target.Highlight.OutlineColor = Options.HighlightOutLineColor.Value
        end)
        ...
        Toggles.FakeHitboxTggle:OnChanged(function()
            Aegians.Aiming.Target.FakeHitbox.Enabled = Toggles.FakeHitboxTggle.Value
        end)
        ...
        Options.FakeHitboxColor:OnChanged(function()
            Aegians.Aiming.Target.FakeHitbox.Color = Options.FakeHitboxColor.Value
        end)
        ...
        Options.TargetFakeHitboxMaterial:OnChanged(function()
            Aegians.Aiming.Target.FakeHitbox.Material = Options.TargetFakeHitboxMaterial.Value
        end)
        ...
        Options.TarggeetFakeHitboxSize:OnChanged(function()
            Aegians.Aiming.Target.FakeHitbox.Size = Options.TarggeetFakeHitboxSize.Value
        end)
        ...
        Toggles.DotPARENTEnabedx:OnChanged(function()
            Aegians.Aiming.Target.Dot.Enabled = Toggles.DotPARENTEnabedx.Value
        end)
        ...
        Options.DotParentForColorxXD:OnChanged(function()
            Aegians.Aiming.Target.Dot.Color = Options.DotParentForColorxXD.Value
        end)
        ...
        Options.TargetOffsetYSlider:OnChanged(function()
            Aegians.Aiming.Target.Offset.Y = Options.TargetOffsetYSlider.Value
        end)
        ...
        Toggles.WristPosEnabledTggle:OnChanged(function()
            Aegians.Aiming.WristPos.Enabled = Toggles.WristPosEnabledTggle.Value
        end)
        ...
        Options.WristPosBindEnabled:OnClick(function()
            if Aegians.Aiming.WristPos.Enabled then
        ...
        Options.WristPosOffsetSlider:OnChanged(function()
            Aegians.Aiming.WristPos.Distance = Options.WristPosOffsetSlider.Value
        end)
        ...
        Toggles.TargetStrafeEnabled:OnChanged(function()
            Aegians.Aiming.TargetStrafe.Enabled = Toggles.TargetStrafeEnabled.Value
        end)
        ...
        Toggles.TargetStrafeVisualizatiONcOLR:OnChanged(function()
            Aegians.Aiming.TargetStrafe.Visualize.Enabled = Toggles.TargetStrafeVisualizatiONcOLR.Value
        end)
        ...
        Options.TargetStrafeVisualizatiONcOLRXX:OnChanged(function()
            Aegians.Aiming.TargetStrafe.Visualize.Color = Options.TargetStrafeVisualizatiONcOLRXX.Value
        end)
        ...
        Options.TargetStrafeDistanceSlid:OnChanged(function()
            Aegians.Aiming.TargetStrafe.Distance = Options.TargetStrafeDistanceSlid.Value
        end)
        ...
        Options.TargetStrafeHeightSlid:OnChanged(function()
            Aegians.Aiming.TargetStrafe.Height = Options.TargetStrafeHeightSlid.Value
        end)
        ...
        Toggles.JumpCooldownTggle:OnChanged(function()
            Aegians.Blatant.Exploits.JumpCooldown = Toggles.JumpCooldownTggle.Value
        end)
        ...
        Toggles.NoSlowdownTgle:OnChanged(function()
            Aegians.Blatant.Exploits.NoSlow = Toggles.NoSlowdownTgle.Value
        end)
        ...
        Toggles.AutoStompTggle:OnChanged(function()
            Aegians.Blatant.Exploits.AutoStomp = Toggles.AutoStompTggle.Value
        end)
        ...
        Toggles.AntiBagEnabledx:OnChanged(function()
            Aegians.Blatant.Exploits.AntiBag = Toggles.AntiBagEnabledx.Value
        end)
        ...
        Toggles.aNTIStompTggle:OnChanged(function()
            Aegians.Blatant.AntiStomp.Enabled = Toggles.aNTIStompTggle.Value
        end)
        ...
        Options.AntiStompDropdown:OnChanged(function()
            Aegians.Blatant.AntiStomp.Type = Options.AntiStompDropdown.Value
        end)
        ...
        Toggles.CFrameSpeedTggle:OnChanged(function()
            Aegians.Blatant.CFrame.Enabled = Toggles.CFrameSpeedTggle.Value
        end)
        ...
        Options.CFrameSpeedAmountXD:OnChanged(function()
            Aegians.Blatant.CFrame.Value = Options.CFrameSpeedAmountXD.Value
        end)
        ...
        Toggles.FakeLagEnabledTggle:OnChanged(function()
            Aegians.Blatant.FakeLag.Enabled = Toggles.FakeLagEnabledTggle.Value
        end)
        ...
        Options.FakeLagEnabledSlider:OnChanged(function()
            Aegians.Blatant.FakeLag.Duration = Options.FakeLagEnabledSlider.Value
        end)
        ...
        task.spawn(function ()
            ...
            newBillboardx.Name = "Aegians_billboardpredictor"
        ...
        Toggles.VelUnderGroundToggle:OnChanged(function()
            Aegians.Blatant.AntiAim.VelocityUnderGround = Toggles.VelUnderGroundToggle.Value
        end)
        ...
        Options.VelocityUndergroundSLider:OnChanged(function()
            Aegians.Blatant.AntiAim.VelocityUnderGroundAmount = Options.VelocityUndergroundSLider.Value
        end)
        ...
        Toggles.AutoReloadTggle:OnChanged(function()
            Aegians.Blatant.GunMod.AutoReload = Toggles.AutoReloadTggle.Value
        end)
        ...
        Toggles.ChamsEnabledTggle:OnChanged(function()
            Aegians.Visuals.Local.Chams = Toggles.ChamsEnabledTggle.Value
        end)
        
        task.spawn(function ()
            while true do
                wait()
                if Aegians.Visuals.Local.Chams then
        ...
        Toggles.GunChamsTggle:OnChanged(function()
            Aegians.Visuals.Local.GunChams.Enabled = Toggles.GunChamsTggle.Value
        end)
        ...
        Options.GunChamsColr:OnChanged(function()
            Aegians.Visuals.Local.GunChams.Color = Options.GunChamsColr.Value
        end)
        
        task.spawn(function ()
            while true do
                wait()
                if Aegians.Visuals.Local.GunChams.Enabled then
                    if game.Players.LocalPlayer.Character:FindFirstChildWhichIsA("Tool") then
                        game.Players.LocalPlayer.Character:FindFirstChildWhichIsA("Tool").Default.Material = "ForceField"
                        game.Players.LocalPlayer.Character:FindFirstChildWhichIsA("Tool").Default.Color = Aegians.Visuals.Local.GunChams.Color
                    end
                else
                    if game.Players.LocalPlayer.Character:FindFirstChildWhichIsA("Tool") then
        ...
        Toggles.LocalHighlight:OnChanged(function()
            Aegians.Visuals.Local.Highlight.Enabled = Toggles.LocalHighlight.Value
        end)
        
        task.spawn(function ()
            while true do
                wait()
                if Aegians.Visuals.Local.Highlight.Enabled then
                    LocalHL.Parent = LocalPlayer.Character
                    LocalHL.FillColor = Aegians.Visuals.Local.Highlight.FillColor
                    LocalHL.OutlineColor = Aegians.Visuals.Local.Highlight.OutlineColor
                else
        ...
        Options.LocalHighlightFillColorColorPicker:OnChanged(function()
            Aegians.Visuals.Local.Highlight.FillColor = Options.LocalHighlightFillColorColorPicker.Value
        end)
        ...
        Options.LocalHighlightOutLineColor:OnChanged(function()
            Aegians.Visuals.Local.Highlight.OutlineColor = Options.LocalHighlightOutLineColor.Value
        end)
        ...
        Toggles.CloneChamsEnabled:OnChanged(function()
            Aegians.Visuals.Local.CloneChams.Enabled = Toggles.CloneChamsEnabled.Value
        end)
        ...
        Options.CloneChamsColor:OnChanged(function()
            Aegians.Visuals.Local.CloneChams.Color = Options.CloneChamsColor.Value
        end)
        
        task.spawn(function ()
            while true do
                wait()
                if Aegians.Visuals.Local.CloneChams.Enabled then
                    repeat
                        ...
                        elseif Obj:IsA("BasePart") or Obj:IsA("Meshpart") or Obj:IsA("Part") then
                            ...
                            Obj.Anchored = true
                            Obj.Material = Aegians.Visuals.Local.CloneChams.Material
                            Obj.Color = Aegians.Visuals.Local.CloneChams.Color
                            Obj.Transparency = 0
                    ...
                    wait(Aegians.Visuals.Local.CloneChams.Duration)
                    Clone:Destroy()  
                    until Aegians.Visuals.Local.CloneChams.Enabled == false
                end
            end
        end)
        ...
        Options.DurationSliderWHAT:OnChanged(function()
            Aegians.Visuals.Local.CloneChams.Duration = Options.DurationSliderWHAT.Value
        end)
        ...
        Options.CloneChamsMaterial:OnChanged(function()
            Aegians.Visuals.Local.CloneChams.Material = Options.CloneChamsMaterial.Value
        end)
        ...
        task.spawn(function ()
            newBillboard.Name = "Aegians_billboarddot"
        ...
        RunService.Stepped:Connect(function ()
            if Aegians.Aiming.Target.Enabled and TargetBindEnabled and TargetTarget.Character then
                if Aegians.Aiming.Target.Dot.Enabled then
                    DotParent.CFrame = CFrame.new(TargetTarget.Character[Aegians.Aiming.Target.Hitbox].Position+Vector3.new(0,Aegians.Aiming.Target.Offset.Y,0)+(TargetTarget.Character[Aegians.Aiming.Target.Hitbox].Velocity*Aegians.Aiming.Target.Prediction))
                    task.spawn(function ()
                        newFrame.BackgroundColor3 = Aegians.Aiming.Target.Dot.Color
                    end)
                    spawn(function ()
                        if Aegians.Aiming.Target.Dot.Enabled == false then
                            DotParent.CFrame = CFrame.new(0,2000,0)
                        end
                    end)
                end
                if Aegians.Aiming.Target.FakeHitbox.Enabled then
                    FakeHitboxPart.CFrame = CFrame.new(TargetTarget.Character.HumanoidRootPart.Position+Vector3.new(0,Aegians.Aiming.Target.Offset.Y,0)+(TargetTarget.Character.HumanoidRootPart.Velocity*Aegians.Aiming.Target.Prediction))
                    spawn(function ()
                        if Aegians.Aiming.Target.FakeHitbox.Enabled == false then
                    ...
                    task.spawn(function ()
                        ...
                        FakeHitboxPart.Color = Aegians.Aiming.Target.FakeHitbox.Color
                        FakeHitboxPart.Size = Vector3.new(1*Aegians.Aiming.Target.FakeHitbox.Size,1*Aegians.Aiming.Target.FakeHitbox.Size,1*Aegians.Aiming.Target.FakeHitbox.Size)
                        if Aegians.Aiming.Target.FakeHitbox.Material == "Neon" then
                            FakeHitboxPart.Transparency = 0
                            FakeHitboxPart.Material = "Neon"
                        end
                        if Aegians.Aiming.Target.FakeHitbox.Material == "ForceField" then
                            FakeHitboxPart.Transparency = 0
                            FakeHitboxPart.Material = "ForceField"
                        end
                        if Aegians.Aiming.Target.FakeHitbox.Material == "Plastic" then
                            FakeHitboxPart.Transparency = 0.75
                            FakeHitboxPart.Material = "Plastic"
                        end
                    end)
                end
                if Aegians.Aiming.Target.ViewAt then
                    workspace.CurrentCamera.CameraSubject = TargetTarget.Character.Humanoid
                    spawn(function ()
                        if Aegians.Aiming.Target.ViewAt == false then
                            workspace.CurrentCamera.CameraSubject = LocalPlayer.Character.Humanoid
                        end
                    end)
                end
                if Aegians.Aiming.Target.Tracer.Enabled then
                    local LineVec = workspace.CurrentCamera:WorldToViewportPoint(TargetTarget.Character[Aegians.Aiming.Target.Hitbox].Position+Vector3.new(0,Aegians.Aiming.Target.Offset.Y,0)+(TargetTarget.Character[Aegians.Aiming.Target.Hitbox].Velocity*Aegians.Aiming.Target.Prediction))
                    ...
                    TracerLine.Color = Aegians.Aiming.Target.Tracer.Color
                    TracerLine.Transparency = 1
                    TracerLine.Thickness = 2
                    TracerLine.To = Vector2.new(LineVec.X, LineVec.Y)
                    TracerLine.Visible = true
                    if Aegians.Aiming.Target.Tracer.From == "Mouse" then
                        TracerLine.From = Vector2.new(LocalPlayerObjs.Mouse.X, LocalPlayerObjs.Mouse.Y + game:GetService("GuiService"):GetGuiInset().Y)
                    end
                    if Aegians.Aiming.Target.Tracer.From == "Head" then
                        TracerLine.From = Vector2.new(headt.X, headt.Y)
                    end
                    if Aegians.Aiming.Target.Tracer.From == "UpperTorso" then
                        TracerLine.From = Vector2.new(humanoidt.X, humanoidt.Y)
                    end
                    if Aegians.Aiming.Target.Tracer.From == "LowerTorso" then
                        TracerLine.From = Vector2.new(lowert.X, lowert.Y)
                    end
                    if Aegians.Aiming.Target.Tracer.From == "Gun" then
                        TracerLine.From = Vector2.new(gunt.X, gunt.Y)
                    end
        
                    spawn(function ()
                        if Aegians.Aiming.Target.Tracer.Enabled == false or Aegians.Aiming.Target.Enabled == false then
                            TracerLine.Visible = false
                        end
                    end)
                end
                if Aegians.Aiming.Target.Highlight.Enabled then
                    HLTarget.Parent = TargetTarget.Character
                    HLTarget.FillColor = Aegians.Aiming.Target.Highlight.FillColor
                    HLTarget.OutlineColor = Aegians.Aiming.Target.Highlight.OutlineColor
                    spawn(function ()
                        if Aegians.Aiming.Target.Highlight.Enabled == false then
                            HLTarget.Parent = game.CoreGui
                        end
                    end)
                end
        
                if Aegians.Aiming.TargetStrafe.Visualize.Enabled and Aegians.Aiming.TargetStrafe.Enabled then
                    targetstraferangepart.CFrame = TargetTarget.Character.HumanoidRootPart.CFrame
                    spawn(function ()
                        targetstraferangepart.Size = Vector3.new(Aegians.Aiming.TargetStrafe.Distance * 0.7, 0.01, Aegians.Aiming.TargetStrafe.Distance * 0.7)
                        targetstraferangepart.Color = Aegians.Aiming.TargetStrafe.Visualize.Color
                    end)
                    spawn(function ()
                        if Aegians.Aiming.TargetStrafe.Visualize.Enabled == false or Aegians.Aiming.TargetStrafe.Enabled == false then
            ...
            if Aegians.Aiming.Target.PingBased == true then
                pingvalue = game:GetService("Stats").Network.ServerStatsItem["Data Ping"]:GetValueString()
                split = string.split(pingvalue,'(')
                ping = tonumber(split[1])
                if ping < 360 then
                    Aegians.Aiming.Target.Prediction = 0.16537
                elseif ping < 270 then
                    Aegians.Aiming.Target.Prediction = 0.195566
                elseif ping < 260 then
                    Aegians.Aiming.Target.Prediction = 0.175566
                elseif ping < 250 then
                    Aegians.Aiming.Target.Prediction = 0.1651
                elseif ping < 240 then
                    Aegians.Aiming.Target.Prediction = 0.16780
                elseif ping < 230 then
                    Aegians.Aiming.Target.Prediction = 0.15692
                elseif ping < 220 then
                    Aegians.Aiming.Target.Prediction = 0.165566
                elseif ping < 210 then
                    Aegians.Aiming.Target.Prediction = 0.16780
                elseif ping < 200 then
                    Aegians.Aiming.Target.Prediction = 0.165566
                elseif ping < 190 then
                    Aegians.Aiming.Target.Prediction = 0.166547
                elseif ping < 180 then
                    Aegians.Aiming.Target.Prediction = 0.19284
                elseif ping < 170 then
                    Aegians.Aiming.Target.Prediction = 0.1923111 
                elseif ping < 160 then
                    Aegians.Aiming.Target.Prediction = 0.16
                elseif ping < 150 then
                    Aegians.Aiming.Target.Prediction = 0.15
                elseif ping < 140 then
                    Aegians.Aiming.Target.Prediction = 0.1223333
                elseif ping < 130 then
                    Aegians.Aiming.Target.Prediction = 0.156692
                elseif ping < 120 then
                    Aegians.Aiming.Target.Prediction = 0.143765
                elseif ping < 110 then
                    Aegians.Aiming.Target.Prediction = 0.1455
                elseif ping < 100 then
                    Aegians.Aiming.Target.Prediction = 0.130340
                elseif ping < 90 then
                    Aegians.Aiming.Target.Prediction = 0.136
                elseif ping < 80 then
                    Aegians.Aiming.Target.Prediction = 0.1347
                elseif ping < 70 then
                    Aegians.Aiming.Target.Prediction = 0.119
                elseif ping < 60 then
                    Aegians.Aiming.Target.Prediction = 0.12731
                elseif ping < 50 then
                    Aegians.Aiming.Target.Prediction = 0.127668
                elseif ping < 40 then
                    Aegians.Aiming.Target.Prediction = 0.125
                elseif ping < 30 then
                    Aegians.Aiming.Target.Prediction = 0.11
                elseif ping < 20 then
                    Aegians.Aiming.Target.Prediction = 0.12588
                elseif ping < 10 then
                    Aegians.Aiming.Target.Prediction = 0.9
                end
            end
            if WristPosBind and Aegians.Aiming.WristPos.Enabled and WristPosTarget.Character and WristPosTarget.Character:FindFirstChild("HumanoidRootPart") then
                if LocalPlayer.Character.RightHand:FindFirstChild("RightWrist") then
                    LocalPlayer.Character.RightHand.RightWrist:Destroy()
                end
                repeat
                    task.wait()
                    LocalPlayer.Character.RightHand.CFrame = CFrame.new(WristPosTarget.Character.HumanoidRootPart.Position) * CFrame.new(0,Aegians.Aiming.WristPos.Distance,0)
                    LocalPlayer.Character.RightHand.Transparency = 1
                until WristPosBind == false or Aegians.Aiming.WristPos.Enabled == false
                if WristPosBind == false or Aegians.Aiming.WristPos.Enabled == false then
        ...
        mt.__namecall = newcclosure(function(...)
            local args = {...}
            if Aegians.Aiming.Target.Enabled and TargetBindEnabled and getnamecallmethod() == "FireServer" and args[2] == "UpdateMousePos" then
                args[3] = TargetTarget.Character[Aegians.Aiming.Target.Hitbox].Position+Vector3.new(0,Aegians.Aiming.Target.Offset.Y,0)+(TargetTarget.Character[Aegians.Aiming.Target.Hitbox].Velocity*Aegians.Aiming.Target.Prediction)
        ...
        RunService.RenderStepped:Connect(function ()
            if Aegians.Aiming.Aimbot.VelocityResolver then
                pcall(function ()
            ...
            if Aegians.Aiming.Aimbot.Enabled and AimbotBindEnabled and Aegians.Aiming.Aimbot.Smoothing.Enabled == false then
                if Aegians.Aiming.Aimbot.ReverseResolver == true then
                    local zxc = CFrame.new(workspace.CurrentCamera.CFrame.p, AimbotTarget.Character[Aegians.Aiming.Aimbot.Hitbox].Position - AimbotTarget.Character[Aegians.Aiming.Aimbot.Hitbox].Velocity/Aegians.Aiming.Aimbot.Prediction)
                ...
                if Aegians.Aiming.Aimbot.ReverseResolver == false then
                    local zxc = CFrame.new(workspace.CurrentCamera.CFrame.p, AimbotTarget.Character[Aegians.Aiming.Aimbot.Hitbox].Position + AimbotTarget.Character[Aegians.Aiming.Aimbot.Hitbox].Velocity/Aegians.Aiming.Aimbot.Prediction)
                    workspace.CurrentCamera.CFrame = workspace.CurrentCamera.CFrame:Lerp(zxc, 1, Enum.EasingStyle.Elastic, Enum.EasingDirection.InOut)
                end
            elseif Aegians.Aiming.Aimbot.Enabled and AimbotBindEnabled and Aegians.Aiming.Aimbot.Smoothing.Enabled == true then
                if Aegians.Aiming.Aimbot.ReverseResolver == true then
                    local zx = CFrame.new(workspace.CurrentCamera.CFrame.p, AimbotTarget.Character[Aegians.Aiming.Aimbot.Hitbox].Position - AimbotTarget.Character[Aegians.Aiming.Aimbot.Hitbox].Velocity/Aegians.Aiming.Aimbot.Prediction)
                    workspace.CurrentCamera.CFrame = workspace.CurrentCamera.CFrame:Lerp(zx, Aegians.Aiming.Aimbot.Smoothing.Value, Enum.EasingStyle.Elastic, Enum.EasingDirection.InOut)
                end
                if Aegians.Aiming.Aimbot.ReverseResolver == false then
                    local zx = CFrame.new(workspace.CurrentCamera.CFrame.p, AimbotTarget.Character[Aegians.Aiming.Aimbot.Hitbox].Position + AimbotTarget.Character[Aegians.Aiming.Aimbot.Hitbox].Velocity/Aegians.Aiming.Aimbot.Prediction)
                    workspace.CurrentCamera.CFrame = workspace.CurrentCamera.CFrame:Lerp(zx, Aegians.Aiming.Aimbot.Smoothing.Value, Enum.EasingStyle.Elastic, Enum.EasingDirection.InOut)
            ...
            if TargetBindEnabled and Aegians.Aiming.Target.Enabled and TargetTarget.Character and TargetTarget.Character:FindFirstChild("HumanoidRootPart") then
                if Aegians.Aiming.Target.LookAt then
                    ...
                    spawn(function ()
                        if Aegians.Aiming.Target.LookAt == false then
        ...
        RunService.Stepped:Connect(function (param,FPS)
            if Aegians.Aiming.TargetStrafe.Enabled then
                if Aegians.Aiming.Target.Enabled and TargetBindEnabled then
                    ...
                    angle_Y = angle_Y + FPS / Aegians.Aiming.TargetStrafe.Speed % 1
                    LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(TargetTarget.Character.HumanoidRootPart.Position) * CFrame.Angles(0, 2 * math.pi * angle_Y, 0) * CFrame.new(0, Aegians.Aiming.TargetStrafe.Height, Aegians.Aiming.TargetStrafe.Distance)
                end
            end
        end)
        ...
        RunService.Heartbeat:Connect(function ()
            ...
            if Aegians.Blatant.CFrame.Enabled then
                if LocalPlayer.Character.Humanoid.MoveDirection.Magnitude > 0 then
                    for i = 1, Aegians.Blatant.CFrame.Value do
                        LocalPlayer.Character:TranslateBy(LocalPlayer.Character.Humanoid.MoveDirection)
                    end
                end
            end
            if Aegians.Blatant.Exploits.JumpCooldown then
                LocalPlayer.Character.Humanoid.UseJumpPower = false
            else 
                LocalPlayer.Character.Humanoid.UseJumpPower = true
            end
            if Aegians.Blatant.Exploits.NoSlow then
                wait()
            ...
            if Aegians.Blatant.Exploits.AutoStomp then
                game.ReplicatedStorage.MainEvent:FireServer("Stomp")
            end
            if Aegians.Blatant.Exploits.AntiBag then
                if LocalPlayer.Character["Christmas_Sock"] then
                    LocalPlayer.Character["Christmas_Sock"]:Destroy()
                end
            end
            if Aegians.Blatant.AntiStomp.Enabled then
                if LocalPlayer.Character.Humanoid.Health <= 1 then
                    if Aegians.Blatant.AntiStomp.Type == "Remove Character" then
                        for i, v in pairs(LocalPlayer.Character:GetDescendants()) do
                            if v:IsA("BasePart") then
                                v:Destroy()
                            end
                        end
                    elseif Aegians.Blatant.AntiStomp.Type == "Remove Humanoid" then
                        LocalPlayer.Character.Humanoid:Destroy()
                    end
                end
            end
            if Aegians.Blatant.FakeLag.Enabled then
                repeat
                    wait()
                    Toggles.AntiFlingEnabled:SetValue(true)
                    wait(Aegians.Blatant.FakeLag.Duration/4)
                    Toggles.AntiFlingEnabled:SetValue(false)
                until Aegians.Blatant.FakeLag.Enabled == false
            end
            if Aegians.Blatant.AntiAim.VelocityUnderGround then
                VelocityUnderGroundAA()
            else
                LocalPlayer.Character.Humanoid.HipHeight = 2
            end
            if Aegians.Blatant.AntiAim.RotVelocity.Enabled then
                RotVelocityAA()
            end
            if Aegians.Blatant.GunMod.AutoReload then
        ...
        Toggles.RainbowModeXD:OnChanged(function()
            Aegians.UISettings.Rainbow = Toggles.RainbowModeXD.Value
        end)
        ...
        function VelocityUnderGroundAA()
            ...
            LocalPlayer.Character.HumanoidRootPart.Velocity = Vector3.new(oldVelocity.X, -Aegians.Blatant.AntiAim.VelocityUnderGroundAmount, oldVelocity.Z)
        ...
        function RotVelocityAA()
            LocalPlayer.Character.HumanoidRootPart.RotVelocity = Vector3.new(0, Aegians.Blatant.AntiAim.RotVelocity.Value, 0)
        end
        
        task.spawn(function()
            while game:GetService("RunService").RenderStepped:Wait() do
                if Aegians.UISettings.Rainbow then
